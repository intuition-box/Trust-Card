...
- Receiving an **invitation unlocks access to the [Minting Ceremony](./mint.mdx)** → it is the gateway to minting a [chest](./chest.mdx) (or [relic](./relic-holder.mdx)). 
...
- Invitations may also be tied to **specific domains of trust** (e.g. *Development*, *NFTs*, *Security*, *Social*, ...).  
  - These domains are connected to both the **[Trust Graph](./trust-graph.mdx)** and the **[Reputation Checker](./reputation-checker.mdx)**, making trust contextual and measurable across different fields.  
