...
- **Distinctive elements**: each physical card reflects both:  
  - the **design of its wave** (frame, colors, specific motifs),  
  - its **rarity tier** (Common, Rare, Epic, Legendary).  
- **QR code** → instant redirection to the corresponding NFT.  
- **NFC chip** → direct access to a *social.card3*-style profile page:  
...
- They also integrate a **rarity distinction**, allowing clear visual differentiation between Common, Rare, Epic, and Legendary holders.  
...
- can link to a **social.card3-style profile page** with custom links,  
